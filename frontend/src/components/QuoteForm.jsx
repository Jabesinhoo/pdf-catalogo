import { FileText, Calendar, User, DollarSign, Hash, Briefcase, Phone, Mail, Clock, MessageSquare } from "lucide-react";
...
function QuoteForm({
  ...
  const data = value ?? quoteMeta ?? {
    ...
    quoteNumber: "",
    paymentNote: "ESTE PRECIO ES SOLO PARA PAGOS EN EFECTIVO O TRANSFERENCIA", // 👈 NUEVO
  };
  ...
  return (
    <section className="panel">
      ...
      <div className="quoteForm__grid quoteForm__grid--horizontal">
        ...
        {/* 👇 NUEVO: Nota de pago personalizable */}
